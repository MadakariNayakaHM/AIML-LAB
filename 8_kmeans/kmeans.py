...
print(sm.classification_report(y_test, kn.predict(X_test), target_names=iris_dataset.target_names))

sns.heatmap(sm.confusion_matrix(y_test, kn.predict(X_test),))